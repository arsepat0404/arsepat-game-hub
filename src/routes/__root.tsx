...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Kumpulan game seru buatan Arsepat. Teka-teki, strategi, multiplayer — langsung main tanpa download!" },
      ...
      { name: "twitter:title", content: "Arsepat — Main Bareng, Gratis!" },
      { name: "twitter:description", content: "Kumpulan game seru buatan Arsepat. Teka-teki, strategi, multiplayer — langsung main tanpa download!" },
