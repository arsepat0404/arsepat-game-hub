...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://arsepat-game-hub.pages.dev" },
      { property: "og:image", content: "https://arsepat-game-hub.pages.dev/og-image.jpg" },
      ...
      { name: "twitter:image", content: "https://arsepat-game-hub.pages.dev/og-image.jpg" },
    ],
    links: [
